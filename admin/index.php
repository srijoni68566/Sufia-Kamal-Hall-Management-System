...
if($username == 'dining' && $password=='dining')
{
	$_SESSION['id']='4';
				$uip=$_SERVER['REMOTE_ADDR'];
				$ldate=date('d/m/Y h:i:s', time());
	header("location:admin-profile-dining_manager.php");
}
else if (($username == 'official' || $username=='official@gmail.com')  && $password=='official')
{
	$_SESSION['id']='5';
				$uip=$_SERVER['REMOTE_ADDR'];
				$ldate=date('d/m/Y h:i:s', time());
	header("location:admin-profile_official.php");
}
else {
...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/mix.jpg);"
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x">Sufia Kamal Hall Management</h1>
